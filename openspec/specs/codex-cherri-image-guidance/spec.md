# Capability: codex-cherri-image-guidance

## Purpose

Define how the repository maintains Codex-facing guidance for Cherri image-related actions and their neighbouring docs surfaces.
